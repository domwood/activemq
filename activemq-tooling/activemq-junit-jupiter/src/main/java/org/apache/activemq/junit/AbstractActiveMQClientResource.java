...
public abstract class AbstractActiveMQClientResource implements BeforeEachCallback, AfterEachCallback {
    ...
    public void beforeEach(ExtensionContext extensionContext) {
        ...
        log.info("Started {}: {}", this.getClass().getSimpleName(), connectionFactory.getBrokerURL());
    }
    ...
    public void afterEach(ExtensionContext extensionContext) {
        ...
        log.info("Stopped {}: {}", this.getClass().getSimpleName(), connectionFactory.getBrokerURL());
    }
