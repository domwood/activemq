 ...
 */
public class EmbeddedActiveMQBroker implements AfterEachCallback, BeforeEachCallback {

    public static final String DEFAULT_BROKER_NAME = "embedded-broker";
    public static final URI DEFAULT_BROKER_VM_URL = defaultURI();
    ...
    public EmbeddedActiveMQBroker() {
        ...
        brokerService.setBrokerName(DEFAULT_BROKER_NAME);
    }
    ...
    private static URI defaultURI() {
        try {
            return new URI("vm://" + DEFAULT_BROKER_NAME);
     ...
     * <p/>
     * Note, force flag is set on the BrokerService start, required for when extension is static,
     * see comments on BrokerService method for more details.
     */
    public void start() {
        try {
            this.configure();
    ...
    public void beforeEach(ExtensionContext extensionContext) throws Exception {
        ...
        log.info("Started embedded ActiveMQ broker: {}", this.getBrokerName());
    }
    ...
    public void afterEach(ExtensionContext extensionContext) throws Exception {
        ...
        log.info("Stopped Embedded ActiveMQ Broker: {}", this.getBrokerName());
    }
